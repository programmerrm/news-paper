        ...
        <footer className="pt-6 lg:pt-12 border-t border-[#E5E5E5]">
            ...
            <div className="bg-[#E0EBF0] py-4">
                <div className="container flex items-center justify-center">
                    <span className="text-sm leading-3.5 tracking-[0.15px] text-black text-center">নিউজফ্ল্যাশ সেভেন্টিওয়ান’র প্রকাশিত কোন সংবাদ, আলাকচিত্র কপিরাইট আইনে পূর্বানুমতি ছাড়া ব্যবহার করা যাবে না</span>
                </div>
            </div>
        </footer>
    );
