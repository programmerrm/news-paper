...
const socialLinks = [
  ...
  },
  {
    href: "#",
    icon: (
        <span className="text-black transition-all duration-500 group-hover:text-white w-3 sm:w-4.5">
  ...
  },
  {
    ...
    icon: (
        ...
        <span className="w-4 sm:w-6">
          <svg className="text-[#FF0000] transition-all duration-500 group-hover:text-white" xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24">
            <path fill="currentColor"
